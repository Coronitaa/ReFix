...
cl /nologo /O2 /EHsc /LD src\eos_proxy.cpp src\eos\eos_identity.cpp src\eos\eos_callbacks.cpp src\eos\eos_connect.cpp src\eos\eos_lobby.cpp src\refix_online\refix_wire.cpp src\refix_online\refix_backend_protocol.cpp src\refix_online\refix_backend_state.cpp src\refix_online\refix_backend_client.cpp src\eos_core\eos_room_manager.cpp src\upnp_firewall.cpp build\eos_fwd.obj /Febuild\EOSSDK-Win64-Shipping.dll user32.lib kernel32.lib advapi32.lib ws2_32.lib wininet.lib ole32.lib oleaut32.lib /link /DEF:src\eos_proxy.def
