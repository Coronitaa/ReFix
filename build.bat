...
cl /nologo /O2 /EHsc /std:c++17 /LD src\eos_proxy.cpp src\identity\online_identity_provider.cpp src\eos\eos_identity.cpp src\eos\eos_callbacks.cpp src\eos\eos_connect.cpp src\eos\eos_lobby.cpp src\refix_online\refix_wire.cpp src\refix_online\refix_backend_protocol.cpp src\refix_online\refix_backend_state.cpp src\refix_online\refix_backend_client.cpp src\eos_core\eos_room_manager.cpp src\upnp_firewall.cpp build\eos_fwd.obj /Febuild\EOSSDK-Win64-Shipping.dll user32.lib kernel32.lib advapi32.lib ws2_32.lib wininet.lib ole32.lib oleaut32.lib /link /DEF:src\eos_proxy.def
...
cl /nologo /O2 /Zi /EHsc /std:c++17 /LD /Isrc\include /Isrc\include\steam src\steam_proxy.cpp src\identity\online_identity_provider.cpp src\steam_p2p_hook.cpp src\upnp_firewall.cpp src\minhook\buffer.c src\minhook\hook.c src\minhook\trampoline.c src\minhook\hde\hde64.c build\steam_fwd.obj /Febuild\steam_api64.dll /Fdbuild\steam_api64.pdb user32.lib kernel32.lib ws2_32.lib iphlpapi.lib ole32.lib oleaut32.lib advapi32.lib /link /DEF:src\steam_api64.def /DEBUG /MAP:build\steam_api64.map
